...
public class ExamenTest {
    ...
    void testGetPreguntas() {
    	assertEquals(preguntas, examen1.getPreguntas(), "Las preguntas del examen 1 no son correctas" );
        assertEquals(preguntas, examen2.getPreguntas(), "Las preguntas del examen 2 no son correctas" );
    }
    @Test
    ...
    void testGetRespuestaGuia() {
        ...
        assertEquals(respuestaGuia1, examen2.getRespuestaGuia(), "La respuesta guia del examen 2 no es correcta" );
    }
